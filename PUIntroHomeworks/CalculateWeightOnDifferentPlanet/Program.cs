...
namespace CalculateWeightOnDifferentPlanet
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Enter your weight in kilograms as measured on Earth:");
            ...
            Console.WriteLine("3: Earth (You already know that)");
